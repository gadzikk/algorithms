 ...
 */
public class FindNumberOfSubarraysSumEven {
    // https://www.geeksforgeeks.org/find-number-subarrays-even-sum/
    static int countEvenSum(int arr[], int n) {
        // A temporary array of size 2. temp[0] is going to store count of even subarrays  and temp[1] count of odd.
        // temp[0] is initialized as  1 because there a single even element is also counted as
        // a subarray
        int temp[] = {1, 0};
